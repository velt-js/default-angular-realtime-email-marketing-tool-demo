# Recording in an Email Client

In this demo, we are using Velt SDK to add native recording feature to an email client

![Sample App Email](sample-app-email.png "Sample Email App")

## Features Used in Demo

- Inline Recording (Screen, Video & Audio)
- Presence
- Sidebar
- Notifications
- Huddle
...
- [Recording](https://docs.velt.dev/async-collaboration/recorder/overview)
